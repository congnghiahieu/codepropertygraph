...
object NewAnnotationLiteral {
  ...
  object InsertionHelpers {
    object NewNodeInserter_AnnotationLiteral_argumentIndex extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        ...
        while (idx < newNodes.length) {
          val nn = newNodes(idx)
          nn match {
            case generated: NewAnnotationLiteral =>
    ...
    object NewNodeInserter_AnnotationLiteral_argumentName extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_AnnotationLiteral_code extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_AnnotationLiteral_columnNumber extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_AnnotationLiteral_lineNumber extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_AnnotationLiteral_name extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_AnnotationLiteral_order extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
...
class NewAnnotationLiteral extends NewNode(1.toShort) with AnnotationLiteralBase with ExpressionNew {
  ...
  override def isValidOutNeighbor(edgeLabel: String, n: NewNode): Boolean = {
    NewAnnotationLiteral.outNeighbors.getOrElse(edgeLabel, Set.empty).contains(n.label)
  }
  override def isValidInNeighbor(edgeLabel: String, n: NewNode): Boolean = {
    NewAnnotationLiteral.inNeighbors.getOrElse(edgeLabel, Set.empty).contains(n.label)
  }
