...
trait MemberEMT extends AnyRef with AstNodeEMT with DeclarationEMT with HasAstParentFullNameEMT with HasAstParentTypeEMT with HasDynamicTypeHintFullNameEMT with HasPossibleTypesEMT with HasTypeFullNameEMT
...
class Member(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 27.toShort , seq_4762) with MemberBase with AstNode with Declaration with StaticType[MemberEMT] {
...
class NewMember extends NewNode(27.toShort) with MemberBase with AstNodeNew with DeclarationNew {
