...
class Type(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 41.toShort , seq_4762) with TypeBase with StaticType[TypeEMT] {
...
object NewType {
  ...
  private val inNeighbors: Map[String, Set[String]] = Map("ALIAS_OF" -> Set("TYPE_DECL"), "EVAL_TYPE" -> Set("ARRAY_INITIALIZER", "BLOCK", "CALL", "CONTROL_STRUCTURE", "IDENTIFIER", "LITERAL", "LOCAL", "MEMBER", "METHOD_PARAMETER_IN", "METHOD_PARAMETER_OUT", "METHOD_REF", "METHOD_RETURN", "TYPE_REF", "UNKNOWN"), "INHERITS_FROM" -> Set("TYPE_DECL"), "REF" -> Set("TYPE_ARGUMENT"))
...
class NewType extends NewNode(41.toShort) with TypeBase {
