...
class TypeArgument(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 42.toShort , seq_4762) with TypeArgumentBase with AstNode with StaticType[TypeArgumentEMT] {
...
class NewTypeArgument extends NewNode(42.toShort) with TypeArgumentBase with AstNodeNew {
  override type StoredNodeType = TypeArgument
  override def label: String = "TYPE_ARGUMENT"

  override def isValidOutNeighbor(edgeLabel: String, n: NewNode): Boolean = {
    NewTypeArgument.outNeighbors.getOrElse(edgeLabel, Set.empty).contains(n.label)
  }
  override def isValidInNeighbor(edgeLabel: String, n: NewNode): Boolean = {
    NewTypeArgument.inNeighbors.getOrElse(edgeLabel, Set.empty).contains(n.label)
  }
