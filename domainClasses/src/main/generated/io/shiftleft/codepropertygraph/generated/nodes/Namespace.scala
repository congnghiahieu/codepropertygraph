...
class Namespace(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 35.toShort , seq_4762) with NamespaceBase with AstNode with StaticType[NamespaceEMT] {
...
object NewNamespace {
  ...
  object InsertionHelpers {
      object NewNodeInserter_Namespace_code extends flatgraph.NewNodePropertyInsertionHelper {
...
object NewNodeInserter_Namespace_columnNumber extends flatgraph.NewNodePropertyInsertionHelper {
  override def insertNewNodeProperties(newNodes: mutable.ArrayBuffer[flatgraph.DNode], dst: AnyRef, offsets: Array[Int]): Unit = {
     if(newNodes.isEmpty) return
...
object NewNodeInserter_Namespace_lineNumber extends flatgraph.NewNodePropertyInsertionHelper {
  override def insertNewNodeProperties(newNodes: mutable.ArrayBuffer[flatgraph.DNode], dst: AnyRef, offsets: Array[Int]): Unit = {
     if(newNodes.isEmpty) return
     val dstCast = dst.asInstanceOf[Array[Int]]
     val seq = newNodes.head.storedRef.get.seq()
...
object NewNodeInserter_Namespace_name extends flatgraph.NewNodePropertyInsertionHelper {
  override def insertNewNodeProperties(newNodes: mutable.ArrayBuffer[flatgraph.DNode], dst: AnyRef, offsets: Array[Int]): Unit = {
     if(newNodes.isEmpty) return
     val dstCast = dst.asInstanceOf[Array[String]]
     val seq = newNodes.head.storedRef.get.seq()
...
object NewNodeInserter_Namespace_order extends flatgraph.NewNodePropertyInsertionHelper {
  override def insertNewNodeProperties(newNodes: mutable.ArrayBuffer[flatgraph.DNode], dst: AnyRef, offsets: Array[Int]): Unit = {
     if(newNodes.isEmpty) return
     val dstCast = dst.asInstanceOf[Array[Int]]
     val seq = newNodes.head.storedRef.get.seq()
...
class NewNamespace extends NewNode(35.toShort) with NamespaceBase with AstNodeNew {
  override type StoredNodeType = Namespace
  override def label: String = "NAMESPACE"

  override def isValidOutNeighbor(edgeLabel: String, n: NewNode): Boolean = {
    NewNamespace.outNeighbors.getOrElse(edgeLabel, Set.empty).contains(n.label)
  }
  override def isValidInNeighbor(edgeLabel: String, n: NewNode): Boolean = {
    NewNamespace.inNeighbors.getOrElse(edgeLabel, Set.empty).contains(n.label)
  }
