...
/** Node base type for compiletime-only checks to improve type safety. EMT stands for: "erased marker trait", i.e. it is
  * erased at runtime
  */
trait LifetimeArgumentEMT extends AnyRef with AstNodeEMT with HasNameEMT

trait LifetimeArgumentBase extends AbstractNode with AstNodeBase with StaticType[LifetimeArgumentEMT] {
...
class LifetimeArgument(graph_4762: flatgraph.Graph, seq_4762: Int)
    extends StoredNode(graph_4762, 22.toShort, seq_4762)
    with LifetimeArgumentBase
    with AstNode
    with StaticType[LifetimeArgumentEMT] {
...
object NewLifetimeArgument {
  ...
  object InsertionHelpers {
    ...
    object NewNodeInserter_LifetimeArgument_columnNumber extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_LifetimeArgument_lineNumber extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
    ...
    object NewNodeInserter_LifetimeArgument_order extends flatgraph.NewNodePropertyInsertionHelper {
      override def insertNewNodeProperties(
        newNodes: mutable.ArrayBuffer[flatgraph.DNode],
        dst: AnyRef,
        offsets: Array[Int]
...
class NewLifetimeArgument extends NewNode(22.toShort) with LifetimeArgumentBase with AstNodeNew {
