...
trait CallEMT extends AnyRef with CallReprEMT with ExpressionEMT with HasDispatchTypeEMT with HasDynamicTypeHintFullNameEMT with HasMethodFullNameEMT with HasPossibleTypesEMT with HasTypeFullNameEMT
...
class Call(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 7.toShort , seq_4762) with CallBase with CallRepr with Expression with StaticType[CallEMT] {
