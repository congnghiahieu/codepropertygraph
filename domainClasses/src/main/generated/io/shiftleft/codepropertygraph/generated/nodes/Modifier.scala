...
class Modifier(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 34.toShort , seq_4762) with ModifierBase with AstNode with StaticType[ModifierEMT] {
...
object NewModifier {
  ...
  object InsertionHelpers {
      object NewNodeInserter_Modifier_code extends flatgraph.NewNodePropertyInsertionHelper {
...
object NewNodeInserter_Modifier_columnNumber extends flatgraph.NewNodePropertyInsertionHelper {
  override def insertNewNodeProperties(newNodes: mutable.ArrayBuffer[flatgraph.DNode], dst: AnyRef, offsets: Array[Int]): Unit = {
     if(newNodes.isEmpty) return
...
object NewNodeInserter_Modifier_lineNumber extends flatgraph.NewNodePropertyInsertionHelper {
  override def insertNewNodeProperties(newNodes: mutable.ArrayBuffer[flatgraph.DNode], dst: AnyRef, offsets: Array[Int]): Unit = {
     if(newNodes.isEmpty) return
     val dstCast = dst.asInstanceOf[Array[Int]]
     val seq = newNodes.head.storedRef.get.seq()
...
object NewNodeInserter_Modifier_modifierType extends flatgraph.NewNodePropertyInsertionHelper {
  override def insertNewNodeProperties(newNodes: mutable.ArrayBuffer[flatgraph.DNode], dst: AnyRef, offsets: Array[Int]): Unit = {
     if(newNodes.isEmpty) return
     val dstCast = dst.asInstanceOf[Array[String]]
     val seq = newNodes.head.storedRef.get.seq()
     ...
     while(idx < newNodes.length){
        ...
        nn match {
          case generated: NewModifier =>
            dstCast(offset) = generated.modifierType
            offset += 1
          case _ =>
        }
        assert(seq + idx == nn.storedRef.get.seq(), "internal consistency check")
...
object NewNodeInserter_Modifier_order extends flatgraph.NewNodePropertyInsertionHelper {
  override def insertNewNodeProperties(newNodes: mutable.ArrayBuffer[flatgraph.DNode], dst: AnyRef, offsets: Array[Int]): Unit = {
     if(newNodes.isEmpty) return
     val dstCast = dst.asInstanceOf[Array[Int]]
     val seq = newNodes.head.storedRef.get.seq()
...
class NewModifier extends NewNode(34.toShort) with ModifierBase with AstNodeNew {
