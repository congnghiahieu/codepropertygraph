...
class TagNodePair(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 39.toShort , seq_4762) with TagNodePairBase with StaticType[TagNodePairEMT] {
     ...
     while(idx < newNodes.length){
        ...
        nn match {
          case generated: NewTagNodePair =>
            dstCast(offset) = generated.node match {case newV:flatgraph.DNode => newV.storedRef.get; case oldV: flatgraph.GNode => oldV; case null => null}
            offset += 1
          case _ =>
        }
...
object NewNodeInserter_TagNodePair_tag extends flatgraph.NewNodePropertyInsertionHelper {
  override def insertNewNodeProperties(newNodes: mutable.ArrayBuffer[flatgraph.DNode], dst: AnyRef, offsets: Array[Int]): Unit = {
     ...
     while(idx < newNodes.length){
        ...
        nn match {
          case generated: NewTagNodePair =>
            dstCast(offset) = generated.tag match {case newV:flatgraph.DNode => newV.storedRef.get; case oldV: flatgraph.GNode => oldV; case null => null}
            offset += 1
          case _ =>
        }
        assert(seq + idx == nn.storedRef.get.seq(), "internal consistency check")
...
class NewTagNodePair extends NewNode(39.toShort) with TagNodePairBase {
