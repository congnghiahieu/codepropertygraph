...
trait TypeDeclEMT extends AnyRef with AstNodeEMT with HasAliasTypeFullNameEMT with HasAstParentFullNameEMT with HasAstParentTypeEMT with HasFilenameEMT with HasFullNameEMT with HasInheritsFromTypeFullNameEMT with HasIsExternalEMT with HasNameEMT with HasOffsetEMT with HasOffsetEndEMT
...
class TypeDecl(graph_4762: flatgraph.Graph, seq_4762: Int) extends StoredNode(graph_4762, 43.toShort , seq_4762) with TypeDeclBase with AstNode with StaticType[TypeDeclEMT] {
...
class NewTypeDecl extends NewNode(43.toShort) with TypeDeclBase with AstNodeNew {
